export const metadata = {
  title: "Media Kit — summa.vision",
  description: "Brand assets and contacts",
};
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="opacity-80">
        Логотипы, палитры и примеры материалов для упоминаний. Для партнёрств и рекламы — пишите на
        email.
      </p>
